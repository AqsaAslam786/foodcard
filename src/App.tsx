  ...
  return (
    <>
      <div className="flex gap-2">
        <FoodManue food={Card} />
        <FoodManue food={Card1} />
        <FoodManue food={Card2} />
        <FoodManue food={Card3} />
      </div>
    </>
  );
}
